...
class WindowsSourcePlugin(WindowsDistributionPlugin, SourcePlugin):
    ...
    def run(self, stage: str):
        ...
        for build in parameters["build"]:
            ...
            # if not (self.component.source_dir / build ).exists():
            ...
            copy_in = [
                ...
                (
                    self.manager.entities["source_windows"].directory,
            ...
            cmd = [
                f"{executor.get_plugins_dir()}/source_windows/scripts/get-source-info "
